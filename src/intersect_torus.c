...
/*   Updated: 2016/04/27 18:53:21 by tbeauman         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	compute_coeffs(t_ray *ray, t_obj *obj, double *a)
{
	...
	e = vec3_dot(x, x) - obj->gr * obj->gr - obj->pr * obj->pr;
	f = vec3_dot(x, ray->dir);
	four_aa = 4 * obj->gr * obj->gr;
	a[0] = (e * e - four_aa * (obj->pr * obj->pr - x.y * x.y)) / dd * dd;
