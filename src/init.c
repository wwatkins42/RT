...
/*   Updated: 2016/03/14 12:23:10 by wwatkins         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_cam(t_env *e, t_cam *cam)
{
	...
	e->cam->aa.supersampling = 4;
	e->cam->aa.supersampling_inc = 1.0 / e->cam->aa.supersampling;
	e->cam->aa.supersampling_coeff = 1.0 / powf(e->cam->aa.supersampling, 2);
